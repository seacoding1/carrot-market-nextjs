      ...
      <div className="bg-white w-full shadow-lg p-5 rounded-3xl
        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            ...
            dark:text-gray-300">In transit</span>
        ...
        <div className="my-2">
          ...
          px-2.5 py-1.5 mr-2 text-xs font-medium rounded-full
          hover:bg-green-500 transition">Today</span>
          <span className="font-medium dark:text-gray-100">9:30~10:30</span>
        </div>
        <div className="relative">
          <div className="bg-gray-200 w-full h-2 rounded-full absolute"/>
          <div className="bg-green-400 h-2 rounded-full w-2/3 absolute"/>
        </div>
        <div className="flex justify-between items-center mt-5 text-gray-600 dark:text-gray-300">
          <span>Expected</span>
          <span>Sorting center</span>
          <span>In transit</span>
          <span className="text-gray-400 dark-gray-500 ">Delivered</span>
        </div>
      </div>
    </main>
  );
